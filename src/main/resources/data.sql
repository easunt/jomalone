INSERT INTO jomalone.attribute (id, maximum, minimum, mutability, name, supported, writable, step) VALUES (1, 100, 0, 'rw', 'brightness', null, null, 10) ON DUPLICATE KEY UPDATE name='brightness';
INSERT INTO jomalone.attribute (id, maximum, minimum, mutability, name, supported, writable, step) VALUES (2, null, null, 'rw', 'power', '["on", "off"]', '["on", "off"]', null) ON DUPLICATE KEY UPDATE name='power';
INSERT INTO jomalone.attribute (id, maximum, minimum, mutability, name, supported, writable, step) VALUES (3, null, null, 'rw', 'colorMode', '["color", "colorTemperature"]', '["color", "colorTemperature"]', null) ON DUPLICATE KEY UPDATE name='colorMode';
INSERT INTO jomalone.attribute (id, maximum, minimum, mutability, name, supported, writable, step) VALUES (4, null, null, 'rw', 'color', null, null, null) ON DUPLICATE KEY UPDATE name='color';
INSERT INTO jomalone.attribute (id, maximum, minimum, mutability, name, supported, writable, step) VALUES (5, 3000, 5700, 'rw', 'colorTemperature', null, null, 100) ON DUPLICATE KEY UPDATE name='colorTemperature';
